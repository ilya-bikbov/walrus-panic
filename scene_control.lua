...
local box_to_move_coords = {x, y}
local box_to_animate = nil
--[[
	Sprites / frames
--]]
local vasya_sheet_option = {
    width = 64,
    height = 64,
    numFrames = 16
}
local vasya_sheet = graphics.newImageSheet("Sprites/Player/vasya_sheet.png", vasya_sheet_option);
local vasya_sheet_sequences = {
	{
    	name = "idle_down",
		frames = {1, 2},
    	time = 800,
...
local vasya_frames = {
    frame1 = {
        type = "image",
        filename = "Sprites/Player/down1.png"
    },
    frame2 = {
        type = "image",
        filename = "Sprites/Player/down2.png"
    },
    frame3 = {
        type = "image",
        filename = "Sprites/Player/down_idle.png"
    },
    frame4 = {
        type = "image",
        filename = "Sprites/Player/left1.png"
    },
    frame5 = {
        type = "image",
        filename = "Sprites/Player/left2.png"
    },
    frame6 = {
        type = "image",
        filename = "Sprites/Player/left_idle.png"
    },
    frame7 = {
        type = "image",
        filename = "Sprites/Player/right1.png"
    },
    frame8 = {
        type = "image",
        filename = "Sprites/Player/right2.png"
    },
    frame9 = {
        type = "image",
        filename = "Sprites/Player/right_idle.png"
    },
    frame10 = {
        type = "image",
        filename = "Sprites/Player/up1.png"
    },
    frame11 = {
        type = "image",
        filename = "Sprites/Player/up2.png"
    },
    frame12 = {
        type = "image",
        filename = "Sprites/Player/up_idle.png"
    }
}
...
local box_frames = {
    frame1 = {
        type = "image",
        filename = "Sprites/box.png"
    },
    frame2 = {
        type = "image",
        filename = "Sprites/box_target.png"
    }
}
...
local wall_frames = {
    frame1 = {
        type = "image",
        filename = "Sprites/wall_brick.png"
    }
}
...
local ground_frames = {
    frame1 = {
        type = "image",
        filename = "Sprites/ground.jpg"
    },
    frame2 = {
        type = "image",
        filename = "Sprites/ground2.jpg"
    }
}
...
local vasya = {
    ...
    width = 32,
    height = 32,
    rect = display.newSprite(vasya_group, vasya_sheet, vasya_sheet_sequences)
}
-- 100% = 64
-- vasya.width это сколько процентов относительно 100?
vasya.rect:scale(vasya.width / vasya.rect.width, vasya.width / vasya.rect.width)
local grounds = {}
    ...
    for m, name in ipairs(level_matrix) do
        for n, name2 in ipairs(name) do
            ...
            if block_type == "0" then
                vasya.rect.x = x
                vasya.rect.y = y
                vasya.rect:setSequence("idle_down")
				vasya.rect:play()
...
local function move1()
	...
	if kostil == 5 then
		if move_direction == "left" then
			vasya.rect:setSequence("idle_left")
			vasya.rect:play()
		elseif move_direction == "right" then
			vasya.rect:setSequence("idle_right")
			vasya.rect:play()
		elseif move_direction == "up" then
			vasya.rect:setSequence("idle_up")
			vasya.rect:play()
		elseif move_direction == "down" then
			vasya.rect:setSequence("idle_down")
			vasya.rect:play()
...
local function move()
	if move_direction == "left" then
		vasya.rect:setSequence("left")
		vasya.rect:play()
	elseif move_direction == "right" then
		vasya.rect:setSequence("right")
		vasya.rect:play()
	elseif move_direction == "up" then
		vasya.rect:setSequence("up")
		vasya.rect:play()
	elseif move_direction == "down" then
		vasya.rect:setSequence("down")
		vasya.rect:play()
	end
